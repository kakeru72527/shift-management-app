...
大学時代にアルバイトで働いていた焼き鳥屋では、シフト申請する際は店舗に置いてある出勤希望シートへ記入する形式でした。スタッフはシフトが入っていない休みの日にわざわざ店舗まで行かないといけないという面倒な点や店長さんもシフト希望の把握や作成したシフトの共有に手間がかかっていたため、店長さんの業務効率の改善にもなるようなシステムがあればと考えていました。そこで、プログラミングを活かして自身でシフト管理アプリが開発できないかと考え、今回制作に至りました。
...
パスワード： password
<br>
サンプルデータ： 2023-11-01にサンプルデータが入っています。
## 機能一覧
